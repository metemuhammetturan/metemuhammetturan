...
## 🛠 Yetkinlikler & Teknoloji Yığını

Yazılım geliştirme süreçlerinde kullandığım temel araçlar ve teknolojiler:

| Alan | Teknolojiler |
| --- | --- |
| **Backend Development** | JavaScript, Node.js, Express.js |
| **Veritabanı** | MongoDB, PostgreSQL |
| **Real-time & Queue** | Redis, BullMQ |
| **Güvenlik & Auth** | JWT, RBAC, Auth Strategies |
| **API & Dokümantasyon** | RESTful API, Swagger/OpenAPI 3.0 |
| **DevOps & Cloud** | DigitalOcean, Render, Git & GitHub |
| **Proje Yönetimi** | Jira, Notion |
...
<a href="mailto:metemhtturan@gmail.com">
  <img src="https://img.shields.io/badge/Email-metemhtturan%40gmail.com-red?style=flat-square&logo=gmail" alt="Email" />
</a>
<a href="https://www.linkedin.com/in/mete-muhammet-turan-8b5abb246/">
  <img src="https://img.shields.io/badge/LinkedIn-Mete%20Muhammet%20Turan-blue?style=flat-square&logo=linkedin" alt="LinkedIn" />
</a>
